...
ttps://docs.djangoproject.com/en/5.0/topics/settings/
...
BASE_DIR = Path(__file__).resolve().parent.parent  # points to root directory
...
SECRET_KEY = 'django-insecure-it6@2&ak3hoxh1xg*=p69fkf@%g^ccxff0!gr7)8404^2i#4!1'
...
# ---------------- Django rest framework simple jwt Jason Web Token Configuration -----------------------------------------
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES':(
        'rest_framework_simplejwt.authentication.JWTAuthentication',
    )
}
# --------------------- Simple Json Token Settings --------------------------------
SIMPLE_JWT = {
...
# ----------------------- Configuring Email Funcitionality ----------------------------------------

EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'
EMAIL_HOST = 'smtp.gmail.com'
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'astorehut@gmail.com'
EMAIL_HOST_PASSWORD = "awusbyxugpmijqbj"
